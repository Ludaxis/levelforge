...
function GameContainer({ level, onBack }: { level: SquareBlockLevel; onBack?: () => void }) {
  const game = useSquareBlockGame(level);
      ...
      <div className="flex flex-col items-center gap-4">
        <Card className="w-full">
          <CardHeader className="pb-2">
            ...
            <CardDescription>
              {level.gameMode === 'push' ? 'Push Mode' : 'Classic Mode'} - {level.rows}x{level.cols} grid
            </CardDescription>
          </CardHeader>
      ...
      <div className="space-y-4">
          ...
          <CardContent className="pt-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-3 bg-muted/50 rounded-lg">
                ...
                <div className="text-xs text-muted-foreground">Blocks Cleared</div>
              </div>
              <div className="text-center p-3 bg-muted/50 rounded-lg">
        ...
        {game.state.isLost && (
          <Card className="border-red-500 border-2">
            ...
            <CardContent>
              <p className="text-sm">
                Too many mistakes! {game.state.blocks.size} blocks remaining. Try again.
              </p>
            </CardContent>
          </Card>
        )}
...
export default function SquareBlockPage() {
  ...
  const handlePlayCustomLevel = (level: SquareBlockLevel) => {
